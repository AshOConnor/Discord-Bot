...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("leaderboard")
        .setDescription("Shows Top 10 Money Earners"),
    async execute(interaction, profileData) {
        ...
        leaderboardEmbed.setFooter({ text: `${username}, you're ranked #${memberIdx + 1} with ${balance}.` });
        ...
        for (let i = 0; i < topTen.length; i++) {
            ...
            desc += `**${i + 1}. ${user.username}:** ${userBalance} dollars.\n`;
        }
        if (desc !== "") {
