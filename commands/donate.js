...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("donate")
        .setDescription("Donate a selected amount of your money to another user")
    ...
    async execute(interaction, profileData) {
        ...
        if (balance < donateAmt) {
            ...
            return await interaction.editReply(`You do not have ${donateAmt} dollars in your balance.`);
        }
        ...
        interaction.editReply(`You have donated ${donateAmt} dollars to ${receiveUser.username}!`);
    },
};